...
Public Class PlantillaVentaService
            ...
            Try
                ...
                Else
                    ...
                    ElseIf errorCode = ModoServicioNoPermitidoException.CODIGO_ERROR Then
                        ...
                        Throw ModoServicioNoPermitidoException.DesdeRespuesta(detallesError, contenido)
                    Else
    ...
    ''' <summary>NestoAPI#518: error.details.modoSugerido del rechazo (la lógica vive en Nesto.Models, Nesto#484).</summary>
    Friend Shared Function LeerModoSugerido(detallesError As JObject) As Byte?
        Return ModoServicioNoPermitidoException.LeerModoSugerido(detallesError)
    End Function

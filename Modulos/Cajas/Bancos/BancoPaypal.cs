...
namespace Nesto.Modulos.Cajas.Bancos
{
    public class BancoPaypal : IBancoConciliacion
    {
        ...
        {
            ContenidoCuaderno43 cuaderno43 = ConvertirPaypalACuaderno43(contenidoFichero);
        ...
        private static ContenidoCuaderno43 ConvertirPaypalACuaderno43(string fileContent)
        {
            ContenidoCuaderno43 contenido = new();
            ...
            contenido.Cabecera = new RegistroCabeceraCuenta
            {
            ...
            contenido.Apuntes = apuntes;

            // Completar la información final de cuenta


            contenido.FinalCuenta = new RegistroFinalCuenta
            {
                ...
                CampoLibreFinal = "".PadRight(4) // Recuerda que son 4 caracteres según el parser
            };

            // Completar la información final de fichero
            contenido.FinalFichero = new RegistroFinalFichero
            {
                CodigoRegistroFinFichero = "88",
                Nueves = "999",
                NumeroRegistros = apuntes.Count + 2,  // +2 para incluir la cabecera y el final de cuenta

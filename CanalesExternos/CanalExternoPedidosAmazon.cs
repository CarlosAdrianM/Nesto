...
namespace Nesto.Modulos.CanalesExternos
{
    public class CanalExternoPedidosAmazon : ICanalExternoPedidos
    {
            ...
            using (new CultureInfoScope("en-US"))
            {
                ...
                foreach (OrderItem orderItem in lineasAmazon)
                {
                    ...
                    LineaPedidoVentaDTO lineaNesto = new LineaPedidoVentaDTO
                    {
                        ...
                        PorcentajeIva = iva == IVA_EXPORTACION ? 0 : porcentajeIva - 1,
        ...
        {
            string productoDevolver = orderItem.SellerSKU;
            ...
            productoDevolver = productoDevolver.EndsWith("FBA") ? productoDevolver.Substring(0, productoDevolver.Length - 3) : productoDevolver;
...
public class CultureInfoScope : IDisposable
{
    ...
    public CultureInfoScope(string cultureName)
    {
        ...
        System.Threading.Thread.CurrentThread.CurrentCulture = CultureInfo.CreateSpecificCulture(cultureName);
    }

...
{
    /// <summary>
    /// Nesto#419 / NestoAPI#333: se envía al liquidar efectos en el Extracto de Cliente. La
    ...
    /// Nesto#490 (4C.1): antes EfectosLiquidadosEvent de Prism.
    /// </summary>
    public sealed class EfectosLiquidadosMensaje : ValueChangedMessage<EfectosLiquidadosPayload>
    {
        public EfectosLiquidadosMensaje(EfectosLiquidadosPayload value) : base(value) { }
    }

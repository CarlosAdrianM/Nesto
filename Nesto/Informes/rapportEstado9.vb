...
Public Class rapportEstado9
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nesto.Views.rapportEstado9.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrapportEstado9
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rapportEstado9 = New rapportEstado9()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class Premio_Vendedores_UL
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Premio Vendedores UL.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nesto.Views.Premio Vendedores UL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPremio_Vendedores_UL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Premio_Vendedores_UL = New Premio_Vendedores_UL()
        rpt.Site = Me.Site
        Return rpt
    End Function

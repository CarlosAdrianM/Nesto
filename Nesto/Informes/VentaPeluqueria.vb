...
Public Class VentaPeluqueria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Nesto.Views.VentaPeluqueria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_soloFactura() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedVentaPeluqueria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaPeluqueria = New VentaPeluqueria()
        rpt.Site = Me.Site
        Return rpt
    End Function

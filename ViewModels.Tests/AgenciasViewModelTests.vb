...
#End Region
    ...
    ' Todos los tests dan error de STA porque el ViewModel depende de TabItem (PestañaSeleccionada).
    ' Una vez eliminada esa dependencia, volver a activar los tests.   
